...
def create_department(request):
    ...
    return render(request, 'employee/department/department_form.html', {'form': form , 'title': 'Department Page',})
...
def create_employee(request):
    ...
    return render(request, 'employee/employee/employee_form.html', {'form': form, 'title': 'Employee Page', })
